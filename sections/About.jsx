...
const About = () => (
  <section className={`${styles.paddings} relative z-10`}>
    ...
    viewport={{once:false , amount:0.25}} className={`${styles.innerWidth} mx-auto ${styles.flexCenter} flex-col`}>
      ...
      <motion.p 
      variants={fadeIn('up','tween',0.2 ,1)} className='mt-[8px] font-normal sm:text-[32px] text-[20px] text-center text-secondary-white leading-[57.6px] md:w-[60%]'>
      ...
      <motion.img variants={fadeIn('up' , 'tween' ,0.3,1 )} src='/arrow-down.svg' alt='arow down'
